...
The first three properties below - safety, authenticity, and liveness - are inherited from
FastPay~\cite{fastpay}. Our contribution is the fourth: relaxing the liveness condition to
healing clients via the recovery mechanism.
...
\label{prop:liveness}
An honest client or a healed client can always transfer funds from its account.
\end{property}
