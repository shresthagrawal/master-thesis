...
(line~\ref{line:execute-transfer}), which subtracts $\mathsf{amt}$ from the sender and adds the same $\mathsf{amt}$
to the recipient. Thus each executed payment preserves the sum of all balances.
